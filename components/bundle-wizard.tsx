  ...
  if (!isHydrated) {
    return (
      <div className="space-y-8">
          ...
          <div className="flex flex-wrap items-center gap-4 md:gap-0">
            {Array.from({ length: 3 }).map((_, index) => (
              <div key={index} className="flex items-center">
                <div>
                  <div className="premium-skeleton animate-shimmer h-3 w-16 rounded-none" />
                  <div className="premium-skeleton animate-shimmer mt-2 h-8 w-40 rounded-none" />
                </div>
        ...
        <div className="grid gap-8 lg:grid-cols-[0.66fr_0.34fr] lg:items-start">
          <div className="space-y-5">
            <div className="flex items-end justify-between gap-6">
              <div className="space-y-2">
                <div className="premium-skeleton animate-shimmer h-12 w-80 rounded-none" />
                <div className="premium-skeleton animate-shimmer h-4 w-full max-w-md rounded-none" />
                <div className="premium-skeleton animate-shimmer h-4 w-80 rounded-none" />
              </div>
              <div className="premium-skeleton animate-shimmer h-5 w-24 rounded-none" />
            </div>
              ...
              {Array.from({ length: 4 }).map((_, index) => (
                ...
                >
                  ...
                  <div className="mt-4 space-y-3">
                    <div className="premium-skeleton animate-shimmer h-6 w-2/3 rounded-none" />
                    <div className="premium-skeleton animate-shimmer h-4 w-1/2 rounded-none" />
                    <div className="premium-skeleton animate-shimmer h-4 w-20 rounded-none" />
                  </div>
                </div>
              ))}
            </div>
